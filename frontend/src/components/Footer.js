      ...
      <Container>
          <Level>
              ...
              <Level.Side align="right">
                  <Level.Item>
                    Follow Us
                    <Icon><a href="https://facebook.com/MEBResources"><FontAwesomeIcon icon={faFacebook} /></a></Icon>
                    <Icon><a href="https://www.instagram.com/mebresources"><FontAwesomeIcon icon={faInstagram} /></a></Icon>
                  </Level.Item>
              </Level.Side>
          </Level>
          <hr />
          <Columns>
            <Columns.Column size="one-quarter">
                <Block><strong>Contact Us</strong></Block>
